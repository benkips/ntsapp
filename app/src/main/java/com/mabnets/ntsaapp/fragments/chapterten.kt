...
import com.mabnets.ntsaapp.databinding.FragmentChaptertenBinding


class chapterten : Fragment(R.layout.fragment_chapterten) {
    private var _binding: FragmentChaptertenBinding? = null
    private val binding get() = _binding!!
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding =  FragmentChaptertenBinding.bind(view)
