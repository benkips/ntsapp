...
import com.mabnets.ntsaapp.databinding.FragmentChapterseventeenBinding

class chapterseventeen : Fragment(R.layout.fragment_chapterseventeen) {
    private var _binding: FragmentChapterseventeenBinding? = null
    private val binding get() = _binding!!
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding =  FragmentChapterseventeenBinding.bind(view)
