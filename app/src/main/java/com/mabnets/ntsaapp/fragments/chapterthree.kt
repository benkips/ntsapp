...
import com.mabnets.ntsaapp.databinding.FragmentChapterthreeBinding


class chapterthree : Fragment(R.layout.fragment_chapterthree) {
    private var _binding: FragmentChapterthreeBinding? = null
    private val binding get() = _binding!!
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding =  FragmentChapterthreeBinding.bind(view)
