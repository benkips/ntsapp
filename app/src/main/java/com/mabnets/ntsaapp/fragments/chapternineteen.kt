...
import com.mabnets.ntsaapp.databinding.FragmentChapternineteenBinding
import com.mabnets.ntsaapp.databinding.FragmentChapteroneBinding


class chapternineteen : Fragment(R.layout.fragment_chapternineteen) {
    private var _binding: FragmentChapternineteenBinding? = null
    private val binding get() = _binding!!
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding =  FragmentChapternineteenBinding.bind(view)
