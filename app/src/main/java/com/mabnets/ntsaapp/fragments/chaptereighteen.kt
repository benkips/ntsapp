...
import com.mabnets.ntsaapp.databinding.FragmentChaptereighteenBinding
import com.mabnets.ntsaapp.databinding.FragmentChapteroneBinding


class chaptereighteen : Fragment(R.layout.fragment_chaptereighteen) {
    private var _binding: FragmentChaptereighteenBinding? = null
    private val binding get() = _binding!!
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding =  FragmentChaptereighteenBinding.bind(view)
