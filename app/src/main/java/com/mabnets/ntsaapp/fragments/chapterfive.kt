...
import com.mabnets.ntsaapp.databinding.FragmentChapterfiveBinding


class chapterfive : Fragment(R.layout.fragment_chapterfive) {
    private var _binding: FragmentChapterfiveBinding? = null
    private val binding get() = _binding!!
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding =  FragmentChapterfiveBinding.bind(view)
