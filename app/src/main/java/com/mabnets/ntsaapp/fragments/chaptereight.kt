...
import com.mabnets.ntsaapp.databinding.FragmentChaptereightBinding
import com.mabnets.ntsaapp.databinding.FragmentChapteroneBinding


class chaptereight : Fragment(R.layout.fragment_chaptereight) {
    private var _binding: FragmentChaptereightBinding? = null
    private val binding get() = _binding!!
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding =  FragmentChaptereightBinding.bind(view)
