...
import com.mabnets.ntsaapp.databinding.FragmentChapternineBinding


class chapternine : Fragment(R.layout.fragment_chapternine) {
    private var _binding: FragmentChapternineBinding? = null
    private val binding get() = _binding!!
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding =  FragmentChapternineBinding.bind(view)
